...
namespace MySchoolProject.Core.Features.ApplicationUser.Commands.Validatiors
{
    public class ChangeUserPasswordValidation : AbstractValidator<ChangeUserPasswordCommand>
    {
        ...
        #endregion
        #region constractors
        public ChangeUserPasswordValidation(IStringLocalizer<SharedResources> stringLocalizer)
        {
